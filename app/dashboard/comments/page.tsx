  ...
  const fetchComments = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Always hide loading state after fetching, regardless of whether we got comments
        setLoading(false);
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-start justify-between gap-2 mb-1.5">
                              ...
                              <div className="hidden sm:flex items-center gap-2 flex-shrink-0">
                                ...
                                {/* Ad Badge */}
                                {comment.isFromAd && (
                                  <span className="px-2 py-0.5 rounded-md text-xs font-medium bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 flex items-center gap-1" title={comment.adName || 'From Ad'}>
